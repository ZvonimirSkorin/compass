        ...
        <div id="new_columns-4-15" className="ct-new-columns">
          <div id="div_block-11-15" className={stlyesServices.BlueBox}>
            <img
              ...
              alt=""
              src="/bled.jpg"
              className={stlyesServices.BlueImg}
            />
            <h3 id="headline-14-15" className={stlyesServices.BoxHeader}>
              Bus Travel
            </h3>
            <div id="text_block-15-15" className={stlyesServices.BoxText} >
              Merry alone do it burst me songs. Sorry equal charm joy her those
              folly ham. In they no.
            </div>
            <a
              id="link_text-16-15"
              className={stlyesServices.BlueButton} 
              href="#"
              target="_self"
              >Learn More</a
            >
