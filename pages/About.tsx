          ...
          <div className="ct-section-inner-wrap">
            ...
            >
              ...
              <div id="div_block-79-7" className={styles.BoxInner}>
                <h2 id="headline-80-7" 
                 className={styles.HBox2}>
                  History
                  
                </h2>
                <div style={{width:"100%",height:"1rem",position:"relative"}}><span className={styles.ADDON}></span></div>
                <div id="text_block-82-7" className={styles.BoxText}>
                  In up so discovery my middleton eagerness dejection explained.
                  Estimating excellence ye contrasted.
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div id="div_block-85-7" className={styles.BoxInner}>
                ...
                <div style={{width:"100%",height:"1rem",position:"relative"}}><span style={{right:0,left:"auto"}} className={styles.ADDON}></span></div>

                <div id="div_block-87-7" className="ct-div-block saas-divider"></div>
                <div id="text_block-88-7" className={styles.BoxText} style={{textAlign:"end",justifyContent:"end",marginLeft:"auto",marginRight:0}}>
                  ...
                  but. Happiness cordially one determine.
                </div>
              </div>
