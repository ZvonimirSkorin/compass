...
const Cards = () => {
    ...
    return (
        ...
        <div className={CardWrapper}>
                ...
                <div>  <Card title="Destinations" text="Get to know about the destinations - where you can explore and what you can see with Kompas Nordic."/> </div>
    ...
    return (
        <div className={articleWrapper}>
            <article className={article}>
                ...
                <section className={ button }>More info</section>
