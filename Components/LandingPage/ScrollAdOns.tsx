...
const ScrollAdOns : React.FC<{initiate:Function}> = (props) =>{
    ...
    const size=useWindowSize()
     useEffect(()=>{
         document.addEventListener('scroll',()=>{
            if(window.scrollY>100){
             ...
             if(Math.abs(window.scrollY-scroll_watcher.current)>30 && height.current>0){
     ...
     return(
            <motion.div style={{height:"3px",backgroundColor:"blue",position:"fixed",top:0,left:0,zIndex:1000,width:`${procentage!==NaN?procentage*100:100}%`}}>
