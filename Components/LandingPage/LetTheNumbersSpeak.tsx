...
const LetTheNumbersSpeak:React.FC = (props) =>{
    ...
    return(
        <div className={styles.LetNumbers}>
         ...
         <div  style={{opacity:0.5,position:"absolute",top:0,left:0,width:"100%",height:"100%",objectFit:"cover",backgroundColor:"black",zIndex:-1}}>
...
export const OneCounter:React.FC<{num:number,link?:string,what?:string}>=(props)=>{
    ...
    return (
      <div onClick={()=>update(200000)} ref={ref}  style={{textAlign:"center",marginTop:"1rem"}}>
        ...
        <div style={{fontSize:"55px",fontWeight:700,color:"#d50000",marginTop:"0.4rem"}} ref={countUpRef} />
