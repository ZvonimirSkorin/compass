...
const router = useRouter()
    ...
    return(
        ...
        className="smallNavBar" style={
          ...
          {paddingLeft:"1rem",backgroundColor:"blue",color:"white",height:"3.6rem",zIndex:1000}}>
...
<ul style={width<800?{fontSize:"0.7rem",display:"flex",alignItems:"center",justifyContent:"start",marginLeft:"-1rem",listStyleType:"none"}:{display:"flex",alignItems:"center",listStyleType:"none"}} >
        ...
        <a style={{cursor:"pointer"}} href="tel: +496170961709"><FontAwesomeIcon icon={faPhone}/><i className="fas fa-phone"></i>
       <span style={{marginLeft:"0.4rem"}}>{width>800?"+420 234 090 170":""}</span></a></li>
        <li style={width<800?{marginLeft:"0.7rem",fontSize:"1.2rem" }:{marginLeft:"1rem"}} >
       <a href = "mailto: skorinzvonimir0@gmail.com">
        <FontAwesomeIcon  icon={faEnvelopeOpen}/>
       <span style={{marginLeft:"0.4rem"}}> {width>800?
        "kompas@kompas.cz":""}</span></a></li>
        <li style={width<800?{marginLeft:"0.7rem",fontSize:"1.2rem"}:{marginLeft:"1rem"}} >
